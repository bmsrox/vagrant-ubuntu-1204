...
# IMPORTANT: THE CODE SUPORTS JUST.tar.gz FILES
VAGRANT_MYSQL_VERSION="http://downloads.mysql.com/archives/get/file/mysql-5.7.3-m13-linux-glibc2.5-i686.tar.gz"
...
# IMPORTANT: THE CODE SUPORTS JUST.tar.gz FILES
#VAGRANT_PHPMYADMIN_VERSION="http://sourceforge.net/projects/phpmyadmin/files/phpMyAdmin/4.2.7.1/phpMyAdmin-4.2.7.1-all-languages.tar.gz"
